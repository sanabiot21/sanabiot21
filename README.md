...
- Deployed internal web applications from scratch using React and Node.js
- Managing asset tracking with SnipeIT (keeping tabs on all the company hardware)
- Running support ops through Zoho Desk ticketing system
